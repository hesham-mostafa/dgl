...
CSRMatrix CSRRowWiseSamplingFused(CSRMatrix mat, IdArray rows, IdArray seed_mapping, std::vector<int64_t>& new_seed_nodes, int64_t num_samples, NDArray prob_or_mask, bool replace);
...
CSRMatrix CSRRowWiseSamplingUniformFused(CSRMatrix mat, IdArray rows, IdArray seed_mapping, std::vector<int64_t>& new_seed_nodes, int64_t num_samples, bool replace);
